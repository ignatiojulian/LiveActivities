...
struct Widgets: WidgetBundle {
   var body: some Widget {
       AstroDeliveryActivityWidget()
       AstroAdActivityWidget()
   }
}

struct AstroDeliveryActivityWidget: Widget {
    var body: some WidgetConfiguration {
        ActivityConfiguration(for: AstroDeliveryAttributes.self) { context in
...
struct AstroAdActivityWidget: Widget {
    var body: some WidgetConfiguration {
        ActivityConfiguration(for: AdAttributes.self) { context in
            HStack {
